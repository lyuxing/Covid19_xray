...
def add_image_3d(inputs, outputs, targets, writer, column, subset, epoch,name):
    ...
    data_all = torchvision.utils.make_grid(data, nrow=int(np.ceil(len(data)/column)), padding=10, normalize=True, range=None, scale_each=True)
    # if subset == 'val':
