...
def generate_grad_cam_inter(net, ori_image,label,criterion):
    """
    :param net: deep learning network(ResNet DataParallel object)
    :param ori_image: the original image
    :return: gradient class activation map
...
def localize(cam_feature, ori_image, frac = 0.2):
    """
...
def show_cam_images(model_ckpt, images, labels, preds, criteration,class_names):
